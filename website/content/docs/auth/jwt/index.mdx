...
The [Authorization Code flow](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1) makes
use of the [Proof Key for Code Exchange (PKCE)](https://datatracker.ietf.org/doc/html/rfc7636)
extension.
...
The JWT Auth Plugin has a full HTTP API. Please see the [API docs](/api/auth/jwt) for more details.
